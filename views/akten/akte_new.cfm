...
<table border="0" width="800px">
	...
	<tr>
		<td>Kontaktperson:</td>
		<td><cfinput name="itBevollmÃ¤chtigt" type="text" size="50" required="true"></td>
		<td>Branche:</td>
		<td>
			<cfselect name="sbBrance"  required="true">
				<option value="1">Versicherung</option>
				<option value="2">BehÃ¶rde</option>
			</cfselect>
		</td>
	</tr>
	<tr>
		<td>StraÃŸe, Hausnummer:</td>
		<td colspan="3"><cfinput name="itStraÃŸe" type="text" size="50" required="true"></td>
	</tr>
	<tr>
		<td>PLZ:</td>
